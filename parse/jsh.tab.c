...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_job_list = 15,                  /* job_list  */
  YYSYMBOL_16_1 = 16,                      /* $@1  */
  YYSYMBOL_17_2 = 17,                      /* $@2  */
  YYSYMBOL_job = 18,                       /* job  */
  YYSYMBOL_pipe_list = 19,                 /* pipe_list  */
  YYSYMBOL_20_3 = 20,                      /* $@3  */
  YYSYMBOL_cmd_and_args = 21,              /* cmd_and_args  */
  YYSYMBOL_22_4 = 22,                      /* $@4  */
...
{
       0,    27,    27,    28,    32,    32,    33,    33,    34,    38,
      45,    45,    46,    50,    50,    54,    54,    55,    60,    61,
      66,    66,    75,    75,    84,    84,    93,    93,   102,   102,
     114,   115
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREAT_GREAT_AMP", "$accept", "input", "job_list", "$@1", "$@2", "job",
  "pipe_list", "$@3", "cmd_and_args", "$@4", "arg_list", "$@5",
  "io_modifier_list", "io_modifier", "$@6", "$@7", "$@8", "$@9", "$@10",
...
#line 1131 "jsh.tab.c"
  ...
  case 9: /* job: pipe_list io_modifier_list background_optional  */
#line 38 "jsh.y"
                                                   {
...
#line 1172 "jsh.tab.c"
  ...
  case 21: /* io_modifier: GREAT $@6 WORD  */
#line 74 "jsh.y"
           { printf("WORD=%s ", (yyvsp[0].string_value)); }
#line 1178 "jsh.tab.c"
    break;
...
#line 1192 "jsh.tab.c"
  ...
  case 23: /* io_modifier: GREAT_AMP $@7 WORD  */
#line 83 "jsh.y"
           { printf("WORD=%s ", (yyvsp[0].string_value)); }
#line 1198 "jsh.tab.c"
    break;
...
#line 1212 "jsh.tab.c"
  ...
  case 25: /* io_modifier: GREAT_GREAT $@8 WORD  */
#line 92 "jsh.y"
           { printf("WORD=%s ", (yyvsp[0].string_value)); }
#line 1218 "jsh.tab.c"
    break;
...
#line 1232 "jsh.tab.c"
  ...
  case 27: /* io_modifier: GREAT_GREAT_AMP $@9 WORD  */
#line 101 "jsh.y"
           { printf("WORD=%s ", (yyvsp[0].string_value)); }
#line 1238 "jsh.tab.c"
    break;
...
#line 1252 "jsh.tab.c"
  ...
  case 29: /* io_modifier: LESS $@10 WORD  */
#line 110 "jsh.y"
           { printf("WORD=%s ", (yyvsp[0].string_value)); }
#line 1258 "jsh.tab.c"
    break;

  case 30: /* background_optional: AMP  */
#line 114 "jsh.y"
        { printf("AMP "); }
#line 1264 "jsh.tab.c"
    break;
